...
export const VEHICLES: Vehicle[] = [
    ...
    { id: 'v26', name: 'Florian Gro├ƒmehring 40/1', type: 'Vehicle', category: 'Fire', subtype: 'HLF 20', stationId: 's21', position: [48.762, 11.532], status: 'Dispatched', fuel: 94, mission: { keyword: 'Smoke Investigation', description: 'Smoke reported', timeline: [{ time: '22:58', event: 'Dispatched: Smoke Investigation' }, { time: '23:05', event: 'Arrived at Scene' }] } },
    { id: 'v27', name: 'Florian Gro├ƒmehring 11/1', type: 'Vehicle', category: 'Fire', subtype: 'MZF', stationId: 's21', position: [48.760, 11.530], status: 'Available', fuel: 85 },
    ...
    { id: 'v_dun1', name: 'Florian D├╝nzlau 44/1', type: 'Vehicle', category: 'Fire', subtype: 'TSF-W', stationId: 's41', position: [48.780, 11.320], status: 'Available', fuel: 85 },
    { id: 'v_dun2', name: 'Florian D├╝nzlau 14/1', type: 'Vehicle', category: 'Fire', subtype: 'MTW', stationId: 's41', position: [48.780, 11.320], status: 'Available', fuel: 92 },
    { id: 'v_dun3', name: 'Florian D├╝nzlau 11/1', type: 'Vehicle', category: 'Fire', subtype: 'MZF', stationId: 's41', position: [48.780, 11.320], status: 'Available', fuel: 90 },
    { id: 'v_muhl1', name: 'Florian M├╝hlhausen 44/1', type: 'Vehicle', category: 'Fire', subtype: 'TSF-W', stationId: 's42', position: [48.790, 11.340], status: 'Available', fuel: 88 },
    { id: 'v_muhl2', name: 'Florian M├╝hlhausen 14/1', type: 'Vehicle', category: 'Fire', subtype: 'MTW', stationId: 's42', position: [48.790, 11.340], status: 'Available', fuel: 94 },
    { id: 'v_muhl3', name: 'Florian M├╝hlhausen 11/1', type: 'Vehicle', category: 'Fire', subtype: 'MZF', stationId: 's42', position: [48.790, 11.340], status: 'Available', fuel: 91 },
    ...
    { id: 'e_kos1', name: 'Rotkreuz K├Âsching 71/1', type: 'Vehicle', category: 'EMS', subtype: 'RTW', stationId: 's6', position: [48.810, 11.500], status: 'Available', fuel: 92 },
    { id: 'e_kos2', name: 'Rotkreuz K├Âsching 76/1', type: 'Vehicle', category: 'EMS', subtype: 'NEF', stationId: 's6', position: [48.810, 11.500], status: 'Available', fuel: 98 },
    { id: 'e_kos3', name: 'Rotkreuz K├Âsching 72/1', type: 'Vehicle', category: 'EMS', subtype: 'KTW', stationId: 's6', position: [48.810, 11.500], status: 'Available', fuel: 90 },
    { id: 'v_ei1', name: 'Florian Eichst├ñtt 40/1', type: 'Vehicle', category: 'Fire', subtype: 'HLF 20', stationId: 's7', position: [48.891, 11.184], status: 'Available', fuel: 93 },
    { id: 'v_ei2', name: 'Florian Eichst├ñtt 30/1', type: 'Vehicle', category: 'Fire', subtype: 'DLK 23/12', stationId: 's7', position: [48.891, 11.184], status: 'Available', fuel: 95 },
    { id: 'v_ei3', name: 'Florian Eichst├ñtt 21/1', type: 'Vehicle', category: 'Fire', subtype: 'TLF 4000', stationId: 's7', position: [48.891, 11.184], status: 'Available', fuel: 91 },
    ...
    { id: 'e_ei1', name: 'Rotkreuz Eichst├ñtt 71/1', type: 'Vehicle', category: 'EMS', subtype: 'RTW', stationId: 's30', position: [48.891, 11.184], status: 'Available', fuel: 93 },
    { id: 'e_ei2', name: 'Rotkreuz Eichst├ñtt 76/1', type: 'Vehicle', category: 'EMS', subtype: 'NEF', stationId: 's30', position: [48.891, 11.184], status: 'Available', fuel: 97 },
    { id: 'e_ei3', name: 'Rotkreuz Eichst├ñtt 72/1', type: 'Vehicle', category: 'EMS', subtype: 'KTW', stationId: 's30', position: [48.891, 11.184], status: 'Available', fuel: 89 },
    ...
    { id: 'v_gross3', name: 'Florian Gro├ƒmehring 14/1', type: 'Vehicle', category: 'Fire', subtype: 'MTW', stationId: 's21', position: [48.760, 11.530], status: 'Available', fuel: 97 },
